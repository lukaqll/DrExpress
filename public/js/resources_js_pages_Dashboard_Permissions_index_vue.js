"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_Dashboard_Permissions_index_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    modalRole: function modalRole(v) {
      this.roleError = '';
      if (!v) this.newRole = {};
    },
    modalEditRole: function modalEditRole(v) {
      this.roleError = '';
      if (!v) this.editRole = {};
    },
    modalPerission: function modalPerission(v) {
      this.permissionError = '';
      if (!v) this.newPermission = {};
    },
    modalEditPerission: function modalEditPerission(v) {
      this.permissionError = '';
  ...
  computed: {
    ...
    permissionsOptions: function permissionsOptions() {
  ...
  methods: {
    getRoles: function getRoles() {
      ...
      this.$commom.request({
        ...
        success: function success(resp) {
          _this.roles = _toConsumableArray(resp);
        }
      });
    },
    createRole: function createRole() {
      ...
      this.$commom.request({
        ...
        success: function success(result) {
          _this2.modalRole = false;
          _this2.newRole = {};
          _this2.roleError = '';

          _this2.getRoles();

          _this2.getRole(result.id);
        },
        error: function error(e) {
          _this2.roleError = _this2.$commom.errorMessages(e);
        }
      });
    },
    getRole: function getRole(id) {
      ...
      this.$commom.request({
        ...
        auth: true,
        success: function success(resp) {
          _this3.editRole = _objectSpread({}, resp);
          _this3.modalEditRole = true;
        }
      });
    },
    updateRole: function updateRole() {
      ...
      this.$commom.request({
        ...
        error: function error(e) {
          _this4.roleError = _this4.$commom.errorMessages(e);
        }
      });
    },
    getPermissions: function getPermissions() {
      ...
      this.$commom.request({
        ...
        auth: true,
        success: function success(resp) {
          _this5.permissions = _toConsumableArray(resp);
        }
      });
    },
    getPermission: function getPermission(id) {
      ...
      this.$commom.request({
        ...
        auth: true,
        success: function success(resp) {
          console.log(_this6.modalEditPermission);
          _this6.editPermission = _objectSpread({}, resp);
          _this6.modalEditPermission = true;
        }
      });
    },
    createPermission: function createPermission() {
      ...
      this.$commom.request({
        ...
        success: function success(result) {
          _this7.newPermission = {};
          _this7.permissionError = '';

          _this7.getPermissions();
        },
        error: function error(e) {
          _this7.permissionError = _this7.$commom.errorMessages(e);
        }
      });
    },
    updatePermission: function updatePermission() {
      ...
      this.$commom.request({
        ...
        success: function success() {
          _this8.modalEditPermission = false;
          _this8.editPermission = {};
          _this8.permissionError = '';

          _this8.getPermissions();
        },
        error: function error(e) {
          _this8.permissionError = _this8.$commom.errorMessages(e);
        }
      });
    },
    getRolePermission: function getRolePermission(id) {
      ...
      this.$commom.request({
        url: "/roles/".concat(id, "/permissions"),
        auth: true,
        success: function success(resp) {
          console.log(resp);
          _this9.rolePermissions = _toConsumableArray(resp);
        }
      });
    },
    removePermission: function removePermission(item) {
      var newEditRole = this.editRole;
      var index = newEditRole.id_permissions.findIndex(function (i) {
        return i == item.value;
      });
      newEditRole.id_permissions.splice(index, 1);
      this.editRole = _objectSpread({}, newEditRole);
    }
  }
});
...
/***/ "./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=script&lang=js&":
/*!*************************************************************************************!*\
  !*** ./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=template&id=745c949a&":
/*!*******************************************************************************************!*\
  !*** ./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=template&id=745c949a& ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_745c949a___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_745c949a___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_745c949a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=745c949a& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=template&id=745c949a&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=template&id=745c949a&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=template&id=745c949a& ***!
  \**********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            [
              ...
              _c(
                ...
                [
                  _c("v-data-table", {
                    attrs: {
                      headers: _vm.permissionsHeaders,
                      items: _vm.permissions,
                      search: _vm.permissionSearch,
                      "item-key": "id",
                    },
                    scopedSlots: _vm._u([
                      {
                        ...
                        fn: function () {
                          return [
                            _c("v-text-field", {
                              ...
                              model: {
                                value: _vm.permissionSearch,
                                callback: function ($$v) {
                                  _vm.permissionSearch = $$v
                                },
                                expression: "permissionSearch",
                              },
                            }),
                          ]
                        },
...
/***/ "./resources/js/pages/Dashboard/Permissions/index.vue":
/*!************************************************************!*\
  !*** ./resources/js/pages/Dashboard/Permissions/index.vue ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_745c949a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=745c949a& */ "./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=template&id=745c949a&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/pages/Dashboard/Permissions/index.vue?vue&type=script&lang=js&");
...
/* harmony import */ var vuetify_lib_components_VBadge__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! vuetify/lib/components/VBadge */ "./node_modules/vuetify/lib/components/VBadge/VBadge.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_745c949a___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_745c949a___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/Dashboard/Permissions/index.vue"
