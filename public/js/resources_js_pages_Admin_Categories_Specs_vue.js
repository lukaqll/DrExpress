"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_Admin_Categories_Specs_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Admin/Categories/Specs.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Admin/Categories/Specs.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getCategory: function getCategory() {
      ...
      if (!this.$can('view-category')) return;
      this.loading = true;
      this.$commom.request({
        url: '/category/' + this.$route.params.id,
        auth: true,
        success: function success(resp) {
          if (!resp.linkable) _this.category = _objectSpread({}, resp);
          _this.loading = false;
        },
    ...
    getSpec: function getSpec(id) {
      var spec = this.category.specs.find(function (s) {
        return s.id == id;
      });
      this.editSpec = _objectSpread({}, spec);
      this.form = 'updateSpec';
    },
    createSpec: function createSpec() {
      var _this2 = this;

      if (!this.$can('create-category')) return;
      this.saveLoading = true;
      this.$commom.request({
        url: "/category/".concat(this.category.id, "/specs"),
        type: 'post',
        auth: true,
        data: this.spec,
        setError: true,
    ...
    updateSpec: function updateSpec() {
      ...
      this.saveLoading = true;
      this.$commom.request({
        url: "/spec/".concat(this.editSpec.id),
        type: 'put',
        auth: true,
        data: this.editSpec,
        setError: true,
    ...
    deleteSpec: function deleteSpec() {
      var _this4 = this;
      ...
      this.$commom.confirm({
        ...
        onConfirm: function onConfirm() {
          ...
          _this4.$commom.request({
            url: "/spec/".concat(_this4.editSpec.id),
            type: 'delete',
            auth: true,
            setError: true,
            success: function success(resp) {
    ...
    getItem: function getItem(item) {
      var itemToTupdate = this.itemsToUpdate;
      itemToTupdate[item.id_spec] = _objectSpread({}, item);
      this.itemsToUpdate = _objectSpread({}, itemToTupdate);
    },
    cancelItemUpdate: function cancelItemUpdate(idSpec) {
      var itemToTupdate = this.itemsToUpdate;
      itemToTupdate[idSpec] = null;
      this.itemsToUpdate = _objectSpread({}, itemToTupdate);
    },
    createItem: function createItem(idSpec) {
      var _this5 = this;

      if (!this.$can('create-category')) return;
      this.saveLoading = true;
      this.$commom.request({
        url: "/spec/".concat(idSpec, "/item"),
        type: 'post',
        auth: true,
        data: {
          name: this.itemsToCreate[idSpec]
        },
        setError: true,
        success: function success(resp) {
          _this5.getCategory();
    ...
    updateItem: function updateItem(idSpec) {
      var _this6 = this;

      if (!this.$can('update-category')) return;
      var item = this.itemsToUpdate[idSpec];
      this.saveLoading = true;
      this.$commom.request({
        url: "/spec-item/".concat(item.id),
        type: 'put',
        auth: true,
        data: item,
        setError: true,
        success: function success(resp) {
          ...
          var itemToTupdate = _this6.itemsToUpdate;
          itemToTupdate[item.id_spec] = null;
          _this6.itemsToUpdate = _objectSpread({}, itemToTupdate);
        },
        error: function error(e) {
          _this6.saveLoading = false;
        }
    ...
    deleteItem: function deleteItem(idSpec, id) {
      var _this7 = this;
      ...
      this.$commom.confirm({
        ...
        onConfirm: function onConfirm() {
          ...
          _this7.$commom.request({
            url: "/spec-item/".concat(id),
            type: 'delete',
            auth: true,
            setError: true,
            success: function success(resp) {
              ...
              _this7.form = 'createSpec';
              _this7.saveLoading = false;

              _this7.cancelItemUpdate(idSpec);
            },
            error: function error(e) {
              _this7.saveLoading = false;
            }
...
/***/ "./resources/js/pages/Admin/Categories/Specs.vue?vue&type=script&lang=js&":
/*!********************************************************************************!*\
  !*** ./resources/js/pages/Admin/Categories/Specs.vue?vue&type=script&lang=js& ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Specs_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Specs.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Admin/Categories/Specs.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Specs_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/pages/Admin/Categories/Specs.vue?vue&type=template&id=8d381124&":
/*!**************************************************************************************!*\
  !*** ./resources/js/pages/Admin/Categories/Specs.vue?vue&type=template&id=8d381124& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Specs_vue_vue_type_template_id_8d381124___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Specs_vue_vue_type_template_id_8d381124___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Specs_vue_vue_type_template_id_8d381124___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Specs.vue?vue&type=template&id=8d381124& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Admin/Categories/Specs.vue?vue&type=template&id=8d381124&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Admin/Categories/Specs.vue?vue&type=template&id=8d381124&":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/Admin/Categories/Specs.vue?vue&type=template&id=8d381124& ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          _c("v-card-title", [
            _c("div", { staticClass: "row" }, [
              _c(
                ...
                [
                  _vm.category.id
                    ? _c("v-breadcrumbs", { attrs: { items: _vm.links } })
                    : _vm._e(),
                ],
                1
              ),
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "v-expansion-panels",
                        { attrs: { multiple: "" } },
                        _vm._l(_vm.category.specs, function (spec, i) {
                          return _c(
                            "v-expansion-panel",
                            { key: i },
                            [
                                    ...
                                    [
                                      ...
                                      spec.items
                                        ? _c(
                                            ...
                                            {
                                              staticClass:
                                                "badge bg-primary rounded-xl",
                                              attrs: { "x-small": "" },
                                            },
                                            [
                                              _vm._v(
                                                _vm._s(spec.items.length || "0")
                                              ),
                                            ]
                                          )
                                        : _vm._e(),
                                        ...
                                        ? _c(
                                            "v-icon",
                                            {
                                              attrs: {
                                                ...
                                                color: "primary",
                                                dark: "",
                                                title: "Múltiplo selecionável",
                                              },
                                            },
                                            [_vm._v("fa fa-list-check")]
                                          )
                                        : _vm._e(),
                                    ],
                                    1
                              ...
                              _c("v-expansion-panel-content", [
                                _c("div", { staticClass: "row" }, [
                                  _c(
                                    "div",
                                    { staticClass: "col-12" },
                                    _vm._l(spec.items, function (item, i) {
                                      return _c(
                                        "v-chip",
                                        {
                                          key: i,
                                          staticClass: "ma-2",
                                          attrs: {
                                            close: _vm.$can("delete-category"),
                                            color:
                                              _vm.itemsToUpdate[spec.id] &&
                                              _vm.itemsToUpdate[spec.id].id ==
                                                item.id
                                                ? "primary"
                                                : "default",
                                          },
                                          on: {
                                            ...
                                            click: function () {
                                              return _vm.itemsToUpdate[
                                                spec.id
                                              ] &&
                                                _vm.itemsToUpdate[spec.id].id ==
                                                  item.id
                                                ? _vm.cancelItemUpdate(spec.id)
                                                : _vm.getItem(item)
                                            },
                                          },
                                        },
                    ...
                    [
                      _vm.form == "updateSpec"
                        ? _c(
                            "div",
                            [
                              _c("h5", [_vm._v("Editar Especificação")]),
                              _vm._v(" "),
                              _c(
                                "v-form",
                                {
                                  ref: "createForm",
                                  attrs: { id: "update-spec" },
                                  on: {
                                    submit: function ($event) {
                                      $event.preventDefault()
                                      return _vm.updateSpec.apply(
                                        null,
                                        arguments
                                      )
                                    },
                                      ...
                                      _c("div", { staticClass: "row" }, [
                                        _c(
                                          ...
                                          [
                                            _c("v-checkbox", {
                                              staticClass: "m-0",
                                              attrs: { label: "Obrigatório" },
                                              model: {
                                                value: _vm.editSpec.is_required,
                                                callback: function ($$v) {
                                                  _vm.$set(
                                                    _vm.editSpec,
                                                    "is_required",
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.form == "createSpec" && _vm.$can("create-category")
                        ? _c(
                            "div",
                            [
                              _c("h5", [_vm._v("Nova Especificação")]),
                              _vm._v(" "),
                              _c(
                                "v-form",
                                {
...
/***/ "./resources/js/pages/Admin/Categories/Specs.vue":
/*!*******************************************************!*\
  !*** ./resources/js/pages/Admin/Categories/Specs.vue ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Specs_vue_vue_type_template_id_8d381124___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Specs.vue?vue&type=template&id=8d381124& */ "./resources/js/pages/Admin/Categories/Specs.vue?vue&type=template&id=8d381124&");
/* harmony import */ var _Specs_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Specs.vue?vue&type=script&lang=js& */ "./resources/js/pages/Admin/Categories/Specs.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Specs_vue_vue_type_template_id_8d381124___WEBPACK_IMPORTED_MODULE_0__.render,
  _Specs_vue_vue_type_template_id_8d381124___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
