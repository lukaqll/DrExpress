...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    citiesOptions: function citiesOptions() {
      ...
      if (this.user.id_uf) {
        var uf = this.ufs.find(function (u) {
          return u.id == _this.user.id_uf;
        });

        if (uf) {
          return uf.cities.map(function (c) {
            return {
              text: c.name,
              value: c.id
            };
  ...
  methods: {
      ...
      if (this.$refs.from.validate()) {
        ...
        this.$commom.request({
          ...
          success: function success(resp) {
            ...
            _this3.errors = '';
            _this3.user = _objectSpread({}, resp);
          },
      ...
      if (this.$refs.passwordForm.validate()) {
        ...
        this.$commom.request({
          ...
          success: function success(resp) {
            ...
            _this4.passwordErrors = '';
            _this4.password = {};
            _this4.passwordModal = false;
          },
          error: function error(e) {
            _this4.passwordErrors = _this4.$commom.errorMessages(e);
            _this4.passwordLoading = false;
          }
        });
      }
    ...
    getUfs: function getUfs() {
      ...
      this.$commom.request({
        ...
        auth: true,
        success: function success(resp) {
          _this5.ufs = _toConsumableArray(resp);
        }
      });
    },
      ...
      if (this.pictureImage) {
        ...
        this.$commom.request({
          ...
          success: function success(resp) {
            ...
            _this6.pictureModal = false;
            _this6.uploading = false;
            _this6.pictureImage = null;
          },
                    ...
                    _c("v-card-text", [
                      _c("div", { staticClass: "row" }, [
                        ...
                        _c(
                          ...
                          [
                            _c("v-autocomplete", {
                              attrs: { label: "Estado", items: _vm.ufsOptions },
                              model: {
