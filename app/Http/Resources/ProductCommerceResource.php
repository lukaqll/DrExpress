...
class ProductCommerceResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'specs'           => ProductSpecResource::collection($this->getNotSelectableSpecs()),
            'selectable_specs'=> ProductSpecResource::collection($this->getSelectableSpecs()),
